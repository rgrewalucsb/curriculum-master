...
* Run `npm init -y` and then `npm install --save webpack@3.10 react react-dom redux react-redux babel-core babel-loader babel-preset-react babel-preset-env lodash` to set up React and Redux
